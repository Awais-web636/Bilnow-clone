...
const testimonials = [
  ...
  },
  {
    id: 4,
    name: "Kevin Turner",
    role: "Compilance Officer",
    image: Kevintestimonial,
  ...
  return (
    <section className="py-16 px-4 bg-white ">
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`relative bg-[#edf3f6] rounded-lg shadow-2xl p-8 transition-transform duration-300 ${isTransitioning ? 'transition-transform' : ''}`}>
            ...
            <div className="flex-1">
              ...
              <div className="mb-4">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M14.017 21 v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                </svg>
              </div>
